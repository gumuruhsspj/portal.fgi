...
<body class="hold-transition sidebar-mini">
                      ...
                      <?php if (isset($management_data) && !empty($management_data)): ?>
                        <?php foreach ($management_data as $row): ?>
                          <tr>
                            ...
                            <td>
                              <img src="<?= base_url() ?>assets/img/uploads/afiliasi/<?= $row->icon; ?>" alt="Product 1" class="img-circle img-size-32 mr-2">
                              <?= $row->nama; ?>
                            </td>
                            <td><?= $row->deskripsi; ?></td>
  ...
  <!-- jQuery -->
  <script src="<?= base_url() ?>assets/js/jquery371.min.js<?= $r; ?>"></script>
  <!-- Bootstrap -->
  <script src="<?= base_url() ?>assets/vendor/bootstrap/js/bootstrap.bundle.min.js<?= $r; ?>"></script>
  <script src="<?= base_url() ?>assets/vendor/datatables/jquery.dataTables.min.js<?= $r; ?>"></script>
  <!-- AdminLTE -->
  <script type="text/javascript">
    const _URL_MAIN_WEBSITE = "<?= base_url(); ?>";
  </script>
  <script src="<?= base_url() ?>assets/js/manage-program-afiliasi.js<?= $r; ?>"></script>
  <script src="<?= base_url() ?>assets/js/settings.js<?= $r; ?>"></script>
  <script src="<?= base_url() ?>assets/js/customer-services.js<?= $r; ?>"></script>
  <script src="<?= base_url() ?>assets/js/timer.js<?= $r; ?>"></script>
  <script src="<?= base_url() ?>assets/js/adminlte.js<?= $r; ?>"></script>
