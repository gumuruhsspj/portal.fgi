...
<head>
  ...
  <title>Management Group Diskusi (<?= $usertype; ?>) Portal - Kursus Komputer</title>
...
<body class="hold-transition sidebar-mini">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Group Diskusi</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Management</a></li>
                <li class="breadcrumb-item"><a href="#">Group Diskusi</a></li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
              ...
              <div class="card">
                <div class="card-header border-0">
                  ...
                  <div class="card-tools">
                    <a href="#" data-bs-toggle="modal" data-bs-target="#groupDiskusiModal" class="btn btn-tool btn-sm">
                ...
                <div class="card-body table-responsive p-0">
                  <table id="table-management-group-diskusi" class="table table-striped table-valign-middle">
                    <thead>
                      <tr>
                    ...
                    <tbody>
                      <?php if (isset($management_data) && !empty($management_data)): ?>
                        <?php foreach ($management_data as $row): ?>
                          <?php $icon = ($row->jenis == 'wa') ? 'wa.png' : 'telegram.png'; ?>
                          <tr>
                            <td>
                              <input type="checkbox" class="data-selected" data-id="<?= $row->id; ?>">
                            </td>
                            <td>
                              <img src="<?= base_url() ?>assets/img/<?= $icon; ?>" alt="Product 1" class="img-circle img-size-32 mr-2">
                              <?= $row->nama; ?>
                            </td>
                            <td><?= $row->jenis; ?></td>
  ...
  <!-- ./wrapper -->
  <?php include('modal_group_diskusi.php'); ?>
  ...
  <script src="<?= base_url() ?>assets/js/manage-group-diskusi.js"></script>
