...
<head>
  ...
  <title>Management Materi (<?= $usertype; ?>) Portal - Kursus Komputer</title>
                        ...
                        <?php foreach ($management_data as $row): ?>
                          <tr>
                            ...
                            <?php if (!empty($row->attachment)): ?>
                              <td><a href="<?= base_url() ?>assets/attachment/uploads/materi/<?= $row->attachment; ?>" target="_blank">Preview</a></td>
                            <?php else: ?>
                              <td>-</td>
                            <?php endif; ?>
                            <?php if (session()->get('usertype') == 'admin'): ?>
