<nav class="main-header navbar navbar-expand navbar-white navbar-light">
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item d-none d-sm-inline-block">
      <a href="<?= base_url() ?>homepage" class="nav-link">Dashboard</a>
    </li>
    <li class="nav-item d-none d-sm-inline-block">
      <a href="<?= base_url() ?>settings" data-bs-toggle="modal" data-bs-target="#settingsModal" class="nav-link">Pengaturan Akun</a>
    </li>
  </ul>
  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right dropdown-shown">
        ...
        <div class="dropdown-divider"></div>
        <a href="<?= base_url() ?>all-notification" class="dropdown-item dropdown-footer">See All Notifications</a>
      </div>
    </li>
