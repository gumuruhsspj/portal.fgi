<form id="materiForm" action="<?= base_url(); ?>manage/materi/add" method="post" enctype="multipart/form-data">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <img src="<?= base_url() ?>assets/img/loading.gif" id="icon-loading" style="display: none;">
            <div class="icon-preview-container">
              <img src="<?= base_url() ?>assets/img/uploads/question.png" id="preview-icon-materi" class="img-thumbnail">
          ...
          <div class="form-group">
            ...
            <img src="<?= base_url() ?>assets/img/loading.gif" id="attachment-loading" style="display: none;">
